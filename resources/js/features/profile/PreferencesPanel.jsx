...
export default function PreferencesPanel({ isOpen, onClose }) {
    ...
    return (
        <aside
            ...
            className={`fixed top-0 right-0 z-50 h-screen w-80 space-y-6 overflow-y-auto border-l border-slate-200/80 bg-white p-6 transition-transform duration-300 ease-in-out lg:relative lg:z-auto lg:h-auto ${
        ...
        >
            <div className="flex items-center justify-between">
                ...
                <button onClick={onClose} aria-label="Fechar preferências" className="p-2 text-slate-400 hover:text-slate-600 lg:hidden">
